...
def spatial_dataset_exists(llm, request, spatial_datasets):
    ...
    prompt = PromptTemplate(
       ...
       with a boolean field 'existing' to indicate if it exists and a string field 'reason' for your
       explanation. Please return JSON only without without any preamble or other explanation. 
