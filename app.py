...
from util import load_coal_mines, load_coal_power_plants, load_wind_power_plants, load_renewable_diesel_fuel_and_other_biofuel_plants, load_battery_storage_plant
