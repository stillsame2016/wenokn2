                ...
                with st.chat_message("assistant"):
                    with st.spinner("Loading data ..."):
                        try:
                            ...
                            st.session_state.requests.append(user_input)
                            st.session_state.sparqls.append((code_for_grouping_object if code_for_grouping_object else "") + "\n\n" (code_for_summarizing_object if code_for_summarizing_object else "") + "\n\n" + code_for_aggregation)
